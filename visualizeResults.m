function [success, visTable] = visualizeResults( resultTable, thresh, resultFFN, targetSize )
%VISUALIZERESULTS Visualize overlays of individual submissions on gt.
%   success = visualizeResults( resultTable, thresh, resultFFN, targetSize ) returns binary
